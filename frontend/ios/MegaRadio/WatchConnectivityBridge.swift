...
class WatchConnectivityBridge: RCTEventEmitter {
    ...
    @objc func initialize() {
        DispatchQueue.main.async { WatchConnectivityHandler.shared.initialize() }
    }
    ...
    @objc func updateFavorites(_ favorites: [[String: Any]]) {
        DispatchQueue.main.async { WatchConnectivityHandler.shared.updateFavorites(favorites) }
    }
    
    @objc func updateNowPlaying(_ nowPlaying: [String: Any]) {
        DispatchQueue.main.async { WatchConnectivityHandler.shared.updateNowPlaying(nowPlaying) }
    }
    
    @objc func updateGenres(_ genres: [[String: Any]]) {
        DispatchQueue.main.async { WatchConnectivityHandler.shared.updateGenres(genres) }
    }
    
    @objc func updateGenreStations(_ stations: [[String: Any]]) {
        DispatchQueue.main.async { WatchConnectivityHandler.shared.updateGenreStations(stations) }
    }
    
    @objc func updateCountries(_ countries: [[String: Any]]) {
        DispatchQueue.main.async { WatchConnectivityHandler.shared.updateCountries(countries) }
    }
    
    @objc func updateCountryStations(_ stations: [[String: Any]]) {
        DispatchQueue.main.async { WatchConnectivityHandler.shared.updateCountryStations(stations) }
    }
    
    @objc func updatePlaybackState(_ isPlaying: Bool) {
        DispatchQueue.main.async { WatchConnectivityHandler.shared.updatePlaybackState(isPlaying) }
    }
