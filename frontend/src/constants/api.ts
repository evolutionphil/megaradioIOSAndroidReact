...
export const API_ENDPOINTS = {
  ...
  stations: {
    ...
    nowPlaying: (id: string) => `/api/now-playing/${id}`,
  },
  ...
  // Metadata endpoints
  metadata: {
    nowPlaying: (stationId: string) => `/api/now-playing/${stationId}`,
  },
  ...
  user: {
    ...
    follow: (userId: string) => `/api/user-engagement/follow/${userId}`,
    unfollow: (userId: string) => `/api/user-engagement/unfollow/${userId}`,
